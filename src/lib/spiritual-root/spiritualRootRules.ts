...
export const SPIRITUAL_ROOT_RULES = {
  ...
  roots: {
    ...
    clash: {
      visibleEchoWeight: 0.15,
      seasonalWeight: 0.2,
      monthSeatBonus: 0.5,
      activationAdvantage: 0.25,
      decisiveAdvantage: 0.75,
      activatedMultiplier: 1.08,
      shakenMultiplier: 0.75,
      damagedMultiplier: 0.5,
      uprootedMultiplier: 0.25,
    },
  ...
  structure: {
    ...
    collectiveWeakRootMinimum: 0.45,
    seasonalNetworkDominantMinimum: 14,
    seasonalNetworkControlledWeakMaximum: 2.25,
    seasonalNetworkDeepWeakMaximum: 3,
    seasonalNetworkDeepPhaseMaximum: -1,
    compoundConstraintFloor: -2.25,
    rootedPotentialMinimum: 0.6,
    formationGatheringScore: 2,
    formationTransformationScore: 2,
    formationSeasonalMinimum: 0.75,
  },
  channelGates: {
    heavenMinimum: 2,
    earthMinimum: 1.1,
  ...
  mutationSource: {
    networkAssistedMinimumScore: 5.5,
    networkAssistedMinimumRoot: 0.6,
    coldThreshold: -0.65,
    hotThreshold: 0.75,
    moistThreshold: 0.25,
    dryThreshold: -0.15,
    decisiveBlockerPatterns: [
      "제압함", "소멸시킴", "열을 식힘", "은폐성을 해침", "기맥 붕괴", "날을 무르게", "재생근", "완충이 부족함",
    ],
  },
  multiRootProfiles: {
    dominantSpread: 5,
