...
const mutations = [
  ...
  ["광 光", "화 + 금", "방출·응축의 균형, 잠재 토 완충", "강한 수·과도한 충돌"],
  ["자뢰 紫雷", "화 + 금", "화금 상극, 충, 토의 완충", "완충 없는 기맥"],
] as const;

export default function MutationsPage() {
  return <InfoPageShell eyebrow="Mutation archive" title="변이영근 도감" intro="두 오행이 있다는 이유만으로 변이가 되지는 않습니다. 유효한 원재료, 관계의 강도, 계절의 지지, 점수 균형과 방해 요소를 함께 확인합니다." disclaimer>
