...
import { AlertTriangle, ArrowLeft, BookMarked, Copy, ShieldAlert, Sparkles } from "lucide-react";
...
export default function ResultPage() {
  ...
  return (
    <main className="shell py-10 sm:py-14">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3"><Link href="/" className="ghost-button"><ArrowLeft size={15} /> 다시 판정</Link><button className="ghost-button" onClick={share}><Copy size={14} />{copied ? "복사됨" : "민감정보 없이 요약 복사"}</button></div>
