...
export default function MethodologyPage() {
  return <InfoPageShell eyebrow="Methodology" title="계산법과 한계" intro="달력 계산의 기준, 시간 보정 방식, 라이브러리 선택과 불확실성을 투명하게 공개합니다." disclaimer>
    ...
    <InfoSection title="영근 발현 모드와 도맥"><p>순천도맥은 득령·득지·생조, 투간통근, 상생 유통·통관, 합국과 청화를 평가합니다. 역천도맥은 역령, 충형의 동세, 극쇠 속 통근·구원, 편기 집중과 충중유구를 평가합니다. 높은 쪽을 최종 도맥 점수로 사용하며 균형 56.5점, 엄격 68.8점의 고정 관문을 적용합니다. 30,000개 결정 표본에서 각 경계는 약 15%와 1%에 해당했습니다. 해시는 1점 미만의 동점 보정에만 쓰며 오행 조건값은 모드에 따라 바뀌지 않습니다.</p></InfoSection>
