...
export default function MethodologyPage() {
  return <InfoPageShell eyebrow="Methodology" title="계산법과 한계" intro="달력 계산의 기준, 시간 보정 방식, 라이브러리 선택과 불확실성을 투명하게 공개합니다." disclaimer>
    ...
    <InfoSection title="영근 발현 모드와 도맥"><p>순천도맥은 득령·득지·생조, 투간통근, 성립된 상생 유통·통관, 합국과 청화를 평가합니다. 역천도맥은 역령, 충형의 동세, 극쇠 속 통근·구원, 편기 집중과 충중유구가 실제로 있을 때만 선택됩니다. 균형 47.0점, 엄격 62.4점의 관문을 적용하며 현재 계산식의 5,000개 고정 검증 표본에서 14.86%와 0.86%가 통과했습니다. 도맥 해시는 1점 미만의 동점 보정에만 쓰며 오행 조건값은 모드에 따라 바뀌지 않습니다.</p></InfoSection>
    <InfoSection title="원국 구성과 기맥 활성"><p>오행이 있다는 사실과 실제 세력을 한 숫자로 섞지 않습니다. 설명용 원국 구성은 천간마다 30, 지지마다 30으로 두고 지장간이 하나면 100%, 둘이면 본기 70%·중기 30%, 셋이면 본기 60%·중기 30%·여기 10%로 나눠 합계 240의 구성비를 냅니다. 이는 공인된 명리 퍼센트가 아니라 재료의 존재를 누락하지 않기 위한 고정 모델입니다. 기맥 활성도는 이와 별도로 월령·왕쇠·통근·투출·생극·합충을 적용합니다.</p></InfoSection>
    <InfoSection title="구조 유효성과 순도"><p>지지 본기와 같은 지장간 본기는 활성도에서 중복 가산하지 않습니다. 본기·중기·여기는 위치와 충손을 반영한 가중 통근으로 바꾸며, 생조 공급원과 통관의 중간 오행은 먼저 자체 기맥이 있어야 합니다. 왕지가 빠진 두 글자는 정식 반합이 아닌 공합 후보입니다. 독립 관문은 4점과 월령·투간통근·합국 등의 연결을 요구합니다. 비극단 구조의 집단 유통은 허용하되 전체 점수 편차가 14.5점을 넘고 활성 2점 미만으로 매몰된 기운은 승격하지 않습니다. 천영근 응축은 주근 14점·부근 5점·격차 9점 관문을 모두 통과해야 하며, 강한 제2 영근이나 변이를 막는 제3 독립 영근을 순도값으로 삭제하지 않습니다.</p></InfoSection>
    <InfoSection title="천간합과 합화"><p>천간 두 글자가 보인다는 이유만으로 합화시키지 않습니다. 이 구현은 보수적으로 인접, 일간 참여, 화신이 월령 또는 완성 합국을 얻음, 원래 오행의 가중 뿌리가 1.25 이하라는 조건을 모두 요구합니다. 부족하면 ‘합이불화’로 두고 독립 작용만 소폭 낮춥니다. 합거와 강한 극제가 같은 기맥을 동시에 누를 때는 중복 감점 하한을 적용합니다.</p></InfoSection>
    <InfoSection title="명리 개념과 창작 전환"><p><Link className="text-[#dfc57f] underline underline-offset-4" href="https://zh.wikisource.org/wiki/%E6%BB%B4%E5%A4%A9%E9%AB%93">《적천수》</Link>의 계절 기세·오행 순역과 <Link className="text-[#dfc57f] underline underline-offset-4" href="https://zh.wikisource.org/wiki/%E6%BB%B4%E5%A4%A9%E9%AB%93%E9%97%A1%E5%BE%AE">《적천수천미》</Link>의 생화 유통·막힘·구원 관점을 참고했습니다. 특히 극열한 명식에서도 수가 진고에 통근하면 ‘한기는 약하지만 뿌리가 있다’고 구분한 사례를 반영했습니다. <Link className="text-[#dfc57f] underline underline-offset-4" href="https://zh.wikisource.org/zh-hant/%E4%B8%89%E5%91%BD%E9%80%9A%E6%9C%83/%E5%8D%B7%E4%BA%8C">《삼명통회》 권2</Link>의 합과 화 구분도 참고했습니다. 다만 구성 비율, 순천·역천도맥, 영근 발현과 순도 배분은 이 서비스가 만든 선협 창작 규칙이며 전통 명리의 길흉 판단이 아닙니다.</p></InfoSection>
