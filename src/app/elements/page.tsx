...
export default function ElementsPage() {
  return <InfoPageShell eyebrow="Five elements" title="오행에서 영근으로" intro="오행은 색만으로 구별하지 않습니다. 글자, 이름, 아이콘과 상생·상극 관계를 함께 표시합니다." disclaimer>
    ...
    <InfoSection title="지장간은 숨은 재료입니다"><p>지지 속에 감춰진 천간을 본기·중기·여기로 구분해 낮은 가중치로 더합니다. 지장간에 희미하게 존재한다는 사실만으로 유효 영근이 되지는 않으며, 외부로 발현할 투출·통근·월령·합국 같은 통로가 필요합니다.</p></InfoSection>
  </InfoPageShell>;
}
